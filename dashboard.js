      ...
      await supabase.functions.invoke(
        "location-insights",
        {
          ...
          body: {
            ...
            admin_latitude: adminPosition.latitude,
            admin_longitude: adminPosition.longitude,

            visitor_latitude: Number(selectedLocation.latitude),
            visitor_longitude: Number(selectedLocation.longitude),
